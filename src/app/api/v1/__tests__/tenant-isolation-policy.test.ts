...
const BASELINE: Record<string, number> = {
  ...
  'src/app/api/v1/bills/[id]/route.ts': 3,
  'src/app/api/v1/credit-notes/[id]/route.ts': 3,
  'src/app/api/v1/customer-categories/[id]/route.ts': 3,
  'src/app/api/v1/customers/[id]/route.ts': 3,
  'src/app/api/v1/debit-notes/[id]/route.ts': 3,
  ...
  'src/app/api/v1/payroll-runs/[id]/post/route.ts': 1,
  'src/app/api/v1/payroll-runs/[id]/route.ts': 3,
  'src/app/api/v1/purchase-orders/[id]/route.ts': 3,
  'src/app/api/v1/purchase-returns/[id]/route.ts': 3,
  'src/app/api/v1/sales-returns/[id]/route.ts': 3,
