...
interface InvoiceWorkbenchLayoutProps {
...
const InvoiceWorkbenchLayout: React.FC<InvoiceWorkbenchLayoutProps> = ({ catalog, detail, showDetail, mobileCatalogOpen, onToggleCatalog }) => {
    if (!showDetail) {
        return (
