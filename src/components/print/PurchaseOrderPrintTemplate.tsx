...
const PurchaseOrderPrintTemplate: React.FC<PurchaseOrderPrintTemplateProps> = ({ purchaseOrder, lineItems = [], vendorName = '-', company = {} }) => {
    if (!purchaseOrder) {
        return <div className="print-template" style={basePageStyle}>No purchase order selected.</div>;
    }
        ...
        <div className="print-template" style={basePageStyle}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '18px' }}>
                ...
                <div style={{ textAlign: 'right' }}>
                    <h2 style={{ margin: 0, fontSize: '28px', letterSpacing: '0.04em' }}>PURCHASE ORDER</h2>
                </div>
            </div>
