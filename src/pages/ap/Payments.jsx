        ...
        },
        {
            ...
            render: (_, row) => (
                <div className="row-actions-end">
                    ...
                    <Button text="Edit" size="small" variant="tertiary" disabled={!canEdit} onClick={(event) => { event.stopPropagation(); navigate('/ap/payments/edit', { state: { mode: 'edit', paymentId: row.id } }); }} />
