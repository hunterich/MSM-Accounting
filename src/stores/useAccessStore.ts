...
export const MODULE_KEYS = {
    ...
    pos_retail:    { label: 'Point of Sale',          group: 'Point of Sale' },
...
export const SIDEBAR_PERMISSION_MAP: Record<string, string[]> = {
    ...
    'Point of Sale':       ['pos_retail'],
    // Fixed assets are guarded by GL_JOURNAL on the API (no ASSETS module key).
    'Assets':              ['gl_journal'],
...
export const SUBITEM_PERMISSION_MAP: Record<string, string> = {
    ...
    '/pos/modifiers':          'pos_retail',
    '/pos/sales-types':        'pos_retail',
    '/assets':                'gl_journal',
    '/assets/categories':     'gl_journal',
    '/assets/depreciation':   'gl_journal',
