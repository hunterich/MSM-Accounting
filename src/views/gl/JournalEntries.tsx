...
const JournalEntries = () => {
    ...
    const columns = [
        ...
        { key: 'totalDebit',  label: 'Total Debit', align: 'right' as const, render: (val: unknown) => formatIDR(val as number) },
        { key: 'totalCredit', label: 'Total Credit', align: 'right' as const, render: (val: unknown) => formatIDR(val as number) },
        {
            key: 'actions',
            label: '',
